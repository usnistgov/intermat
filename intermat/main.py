...
class InterfaceCombi(object):
                        ...
                        for subs_index in self.subs_indices:
                            for thickness in self.thicknesses:
                                for dis in self.xy:
                                    ...
                                    chosen_info['interface']=chosen_info['interface'].to_dict()
    ...
    def calculate_wad_alignn(self,model_path=''):
        x = self.generate()
        from alignn.ff.ff import AlignnAtomwiseCalculator, default_path, wt01_path, ForceField, wt10_path
        if model_path=='':
