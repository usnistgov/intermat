...
| ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Getting started](https://colab.research.google.com/github/usnistgov/jarvis-tools-notebooks/blob/master/jarvis-tools-notebooks/intermat_gettingstarted.ipynb)                                                       | [![Open in Google Colab]](https://colab.research.google.com/github/usnistgov/jarvis-tools-notebooks/blob/master/jarvis-tools-notebooks/intermat_gettingstarted.ipynb)                                 | Installation of InterMat and generation of atomistic interface geometries given two similar or different materials and other examples.                                                                                                                                                                                                                                                                        |
